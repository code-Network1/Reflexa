...
#elif COLOR_SCHEME == 1  // New shoka (Enhanced)
    #define OMNI_TINT 0.20
    #define LIGHT_SUNSET_COLOR vec3(1.0, 0.65, 0.40)
    #define LIGHT_DAY_COLOR vec3(0.95, 0.88, 0.82)
    #define LIGHT_NIGHT_COLOR vec3(0.055, 0.062, 0.075) * NIGHT_BRIGHT_PHASE
